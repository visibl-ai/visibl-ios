...
//        }
        ...
        buttons.append(UIBarButtonItem(image: UIImage(systemName: "ellipsis"), style: .plain, target: self, action: #selector(sharePublication)))

        return buttons
    }
    
    @objc private func sharePublication() {
        print("sharing publication")
    }
