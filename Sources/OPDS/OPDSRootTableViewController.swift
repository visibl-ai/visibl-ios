...
class OPDSRootTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    typealias Factory =
    ...
    private var skeletonView: SkeletonUIView?
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        navigationItem.title = "store_title".localized
    ...
    private func showSkeletonView() {
        ...
        NSLayoutConstraint.activate([
            ...
            skeletonView.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor),
            skeletonView.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor),
