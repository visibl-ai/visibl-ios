...
protocol ModuleDelegate: AnyObject {
    ...
    func presentAlertWithButtons(_ title: String, message: String, buttons: [(String, (() -> Void)?)], from viewController: UIViewController)
}
...
//        let settingsViewController = SettingsController(aaxManager: <#AAXManager#>)
